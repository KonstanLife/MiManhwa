...
import com.example.mimanhwa.Activities.AddActivity.AddGenreActivity;
...
public class ManagementGenreActivity extends AppCompatActivity {


    //View items
    private FloatingActionButton add_genre_btn;
    ...
    //adapter
    private AdapterManagementGenre adapterManagementGenre;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_management_genre);

        //Inicializacion de view items
        add_genre_btn = findViewById(R.id.add_genre_float_btn);
        recyclerView = findViewById(R.id.management_genre_rv);
       ...
       // checkUser();
        ...
        //click listener
        add_genre_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ManagementGenreActivity.this, AddGenreActivity.class));
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                try {
                     adapterManagementGenre.getFilter().filter(newText);
                }catch (Exception e){
    ...
    private void loadCategories() {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //setup adapter
                adapterManagementGenre = new AdapterManagementGenre(ManagementGenreActivity.this,genreArrayList);

                //set adapte to recicler view
                recyclerView.setAdapter(adapterManagementGenre);
            }
